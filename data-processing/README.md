Global Rangelands Data Platform (GRASS)
==============================
...
```shell
docker exec -it global_rangelands_data_platform_notebooks /bin/bash
```
...
``` bash
mamba env create -n global_rangelands_data_platform -f environment.yml
```

This will create an environment called global-rangelands-data-platform with a common set of dependencies.
