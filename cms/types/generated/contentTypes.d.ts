...
export interface ApiDatasetDataset extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    citations: Schema.Attribute.Component<'default.citations', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEcoregionEcoregion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rangeland: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiLayerLayer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    legend: Schema.Attribute.Component<'default.legend', false> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    title: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    translations: Schema.Attribute.Component<
      'translations.layer-translation',
      true
    > &
      Schema.Attribute.SetMinMax<
        {
...
export interface ApiRangelandRangeland extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ecoregions: Schema.Attribute.Relation<
      'oneToMany',
      'api::ecoregion.ecoregion'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
