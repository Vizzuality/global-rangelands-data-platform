...
const LayerVisibility = ({ onChangeVisibility, visible }: LayerVisibilityProps) => {
  return (
    <Toggle
      className="hover:text-hunter-green-400 group h-5 w-5 rounded-full px-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-300 focus-visible:ring-offset-0"
...
const LayerOpacity = ({ opacity = 1, onChangeOpacity }: LayerOpacityProps) => (
  <Popover>
    <PopoverTrigger className="hover:text-hunter-green-400  h-5 w-5 rounded-full pl-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-300">
      <OpacityIcon
        style={{
          opacity: opacity + 0.2,
        }}
...
const LayerInfo = ({ info, title, ...props }: LayerInfoProps) => (
  <Dialog {...props}>
    <DialogTrigger
      disabled={!info}
      className="hover:text-hunter-green-400 h-min  rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-300"
    >
