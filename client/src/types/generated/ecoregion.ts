...
export const getPostEcoregionsMutationKey = () => ["postEcoregions"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    PostEcoregionsMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof API>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getPostEcoregionsMutationKey();
...
export type PostEcoregionsMutationVariables = { data: EcoregionRequest };
...
export const getPutEcoregionsIdMutationKey = () => ["putEcoregionsId"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    PutEcoregionsIdMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof API>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getPutEcoregionsIdMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type PutEcoregionsIdMutationVariables = { id: string; data: EcoregionRequest };
...
export const getDeleteEcoregionsIdMutationKey = () => ["deleteEcoregionsId"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    DeleteEcoregionsIdMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof API>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getDeleteEcoregionsIdMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type DeleteEcoregionsIdMutationVariables = { id: string };
