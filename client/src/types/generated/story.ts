...
export const getPostStoriesMutationKey = () => ["postStories"] as const;
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = getPostStoriesMutationKey();
...
export type PostStoriesMutationVariables = { data: StoryRequest };
...
export const getPutStoriesIdMutationKey = () => ["putStoriesId"] as const;
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = getPutStoriesIdMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type PutStoriesIdMutationVariables = { id: string; data: StoryRequest };
...
export const getDeleteStoriesIdMutationKey = () => ["deleteStoriesId"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    DeleteStoriesIdMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof API>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getDeleteStoriesIdMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type DeleteStoriesIdMutationVariables = { id: string };
