...
export const getPostDatasetsMutationKey = () => ["postDatasets"] as const;
...
>(options?: {
  ...
  TContext
> => {
  const mutationKey = getPostDatasetsMutationKey();
...
export type PostDatasetsMutationVariables = { data: DatasetRequest };
...
export const getPutDatasetsIdMutationKey = () => ["putDatasetsId"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    PutDatasetsIdMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof API>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getPutDatasetsIdMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type PutDatasetsIdMutationVariables = { id: string; data: DatasetRequest };
...
export const getDeleteDatasetsIdMutationKey = () => ["deleteDatasetsId"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    DeleteDatasetsIdMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof API>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getDeleteDatasetsIdMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type DeleteDatasetsIdMutationVariables = { id: string };
