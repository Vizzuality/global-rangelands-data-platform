...
export function useGetDatasetCategories<
  ...
  TError = ErrorType<Error>,
>(
  params: undefined | GetDatasetCategoriesParams,
  options: {
    query: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getDatasetCategories>>, TError, TData>
    > &
...
export const getPostDatasetCategoriesMutationKey = () => ["postDatasetCategories"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    PostDatasetCategoriesMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof API>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getPostDatasetCategoriesMutationKey();
...
export type PostDatasetCategoriesMutationVariables = { data: DatasetCategoryRequest };

export const usePostDatasetCategories = <TError = ErrorType<Error>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof postDatasetCategories>>,
      TError,
...
>(
  ...
  return {
    ...
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof getDatasetCategoriesId>>, TError, TData> & {
    queryKey: DataTag<QueryKey, TData>;
  };
};
...
export function useGetDatasetCategoriesId<
  TData = Awaited<ReturnType<typeof getDatasetCategoriesId>>,
  TError = ErrorType<Error>,
>(
  id: string,
...
export const getPutDatasetCategoriesIdMutationKey = () => ["putDatasetCategoriesId"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    PutDatasetCategoriesIdMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof API>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getPutDatasetCategoriesIdMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type PutDatasetCategoriesIdMutationVariables = { id: string; data: DatasetCategoryRequest };

export const usePutDatasetCategoriesId = <TError = ErrorType<Error>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof putDatasetCategoriesId>>,
      TError,
...
export const deleteDatasetCategoriesId = (
  ...
  return API<number>({ url: `/dataset-categories/${id}`, method: "DELETE", signal }, options);
};

export const getDeleteDatasetCategoriesIdMutationKey = () => ["deleteDatasetCategoriesId"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    DeleteDatasetCategoriesIdMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof API>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getDeleteDatasetCategoriesIdMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type DeleteDatasetCategoriesIdMutationVariables = { id: string };

export const useDeleteDatasetCategoriesId = <TError = ErrorType<Error>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof deleteDatasetCategoriesId>>,
      TError,
