...
export const getPostRangelandsMutationKey = () => ["postRangelands"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    PostRangelandsMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof API>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getPostRangelandsMutationKey();
...
export type PostRangelandsMutationVariables = { data: RangelandRequest };
...
export const getPutRangelandsIdMutationKey = () => ["putRangelandsId"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    PutRangelandsIdMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof API>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getPutRangelandsIdMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type PutRangelandsIdMutationVariables = { id: string; data: RangelandRequest };
...
export const getDeleteRangelandsIdMutationKey = () => ["deleteRangelandsId"] as const;
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    DeleteRangelandsIdMutationVariables,
    TContext
  >;
  request?: SecondParameter<typeof API>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = getDeleteRangelandsIdMutationKey();
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation && "mutationKey" in options.mutation && options.mutation.mutationKey
      ? options
      : { ...options, mutation: { ...options.mutation, mutationKey } }
...
export type DeleteRangelandsIdMutationVariables = { id: string };
